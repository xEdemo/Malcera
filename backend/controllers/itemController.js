...
const deleteItem = async (req, res) => {
    ...
    const numberOfInventoriesUpdated = await replaceInventorySlot(itemId, emptySlot);
    const numberOfCharactersUpdated = await replaceCharacterSlot(itemId, emptySlot);
